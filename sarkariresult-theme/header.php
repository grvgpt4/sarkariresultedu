...
<header class="sre-header" role="banner">
	<div class="sre-header__inner sre-container">
		<div class="sre-header__branding">
			<?php sre_site_brand(); ?>
			<?php
			$tagline = sre_get_mod( 'sre_site_tagline', __( 'Latest Sarkari Jobs, Results, Admit Card & Education Updates', 'sarkariresult' ) );
			if ( $tagline ) :
				?>
				<p class="sre-header__tagline"><?php echo esc_html( $tagline ); ?></p>
			<?php endif; ?>
		</div>

		<div class="sre-header__actions">
